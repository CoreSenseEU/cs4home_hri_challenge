...
class TransportBagCM : public cs4home_core::CognitiveModule {
public:
  explicit TransportBagCM(
      const rclcpp::NodeOptions &options = rclcpp::NodeOptions())
      : cs4home_core::CognitiveModule("transport_bag_cognitive_module", options) {
...
int main(int argc, char **argv) {
  ...
  auto node = std::make_shared<TransportBagCM>();
